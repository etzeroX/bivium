...
const en = {
  ...
  mcpCatalogRequired: "Waiting for restarted Codex to request the model catalog",
  tunnelId: "Tunnel ID",
...
const zh: Record<keyof typeof en, string> = {
  ...
  mcpCatalogRequired: "正在等待重启后的 Codex 请求模型列表",
  tunnelId: "Tunnel ID",
...
const ja: Record<keyof typeof en, string> = {
  ...
  mcpCatalogRequired: "再起動した Codex がモデルカタログを要求するのを待っています",
  tunnelId: "Tunnel ID",
...
const ko: Record<keyof typeof en, string> = {
  ...
  mcpCatalogRequired: "다시 시작된 Codex가 모델 카탈로그를 요청하기를 기다리는 중",
  tunnelId: "Tunnel ID",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  mcpCatalogRequired: "正在等待重新啟動的 Codex 請求模型目錄",
  tunnelId: "Tunnel ID",
  runtimeKey: "API key（不是 Admin key）",
  connect: "連線 Harness",
